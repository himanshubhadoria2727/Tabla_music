        ...
        <>
            <LayoutHoc>
                <Col className={`${styles.title}`}>
                    <h3>Add Lesson</h3>
                    <Link href="/manage-lesson">  <FilledButtonComponent className={`${styles.arrowBtn}`}> <SVG.Arrow /> Back</FilledButtonComponent></Link>
                </Col>
                <Col className='tableBox'>
                    <Col style={{ marginBottom: "14px" }}>
                        <LabelInputComponent title="Manage Lesson Name" type="search" />
